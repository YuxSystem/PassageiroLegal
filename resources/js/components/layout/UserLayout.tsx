...
import { PlaneTakeoff, FileText, PlusCircle } from 'lucide-react';
...
const UserLayout: React.FC<UserLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    {
      title: t('solicitations.newSolicitation'),
      icon: <PlusCircle className="w-5 h-5" />,
      href: '/nova-solicitacao',
    },
    {
      title: t('solicitations.mySolicitations'),
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="cursor-pointer" onClick={() => router.get('/perfil')}>
