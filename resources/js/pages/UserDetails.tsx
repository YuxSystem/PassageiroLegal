...
import { Power, UserCog, ArrowLeft, Eye, MoreVertical, CheckCircle2, XCircle, MessageCircle, MessageSquare } from "lucide-react";
...
const UserDetails: React.FC<Props> = ({ user, solicitations, solicitations_pagination }) => {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = user.cellphone?.replace(/\D/g, '');
    if (phoneNumber) {
